...
Ce projet consiste à réaliser une horloge offrant à  la fois des services d'horloge analogique et digital; donnant la possibilité à l'utilisateur de faire des navettes entre différents thèmes . Cette horloge offre aussi un service d'alarme!

## En quoi ça consiste réellement?

Ce projet ( Horloge) a pour but de permettre aux utulisateurs de se familliariser avec une app horlographique , comme tout autre app particulière. 
...
* D'éviter de faire un choix entre analogique et digital ( en donnant la possibilité d'utiliser les deux en les  affichant au moments) plus besoin de faire un choix...
